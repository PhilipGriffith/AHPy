...
#
#     assert a.report() == {'name': 'a', 'weight': 1.0, 'weights': {'local': {'b': 0.5, 'c': 0.5}, 'global': {'b': 0.5, 'c': 0.5}, 'target': {'z': 0.4652, 'y': 0.3626, 'x': 0.1723}}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 2, 'names': ['b', 'c']}, 'children': {'count': 2, 'names': ['b', 'c']}, 'comparisons': {'count': 1, 'input': {('b', 'c'): 1}, 'computed': None}}
...
#     assert c.report() == {'name': 'c', 'weight': 0.5, 'weights': {'local': {'h': 0.5, 'f': 0.25, 'g': 0.25}, 'global': {'h': 0.25, 'f': 0.125, 'g': 0.125}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 3, 'names': ['f', 'g', 'h']}, 'children': {'count': 3, 'names': ['f', 'g', 'h']}, 'comparisons': {'count': 3, 'input': {('f', 'g'): 1, ('g', 'h'): 0.5}, 'computed': {('f', 'h'): 0.5000007807004769}}}
#     assert d.report() == {'name': 'd', 'weight': 0.4, 'weights': {'local': {'i': 0.6667, 'j': 0.3333}, 'global': {'i': 0.2667, 'j': 0.1333}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 2, 'names': ['i', 'j']}, 'children': {'count': 2, 'names': ['i', 'j']}, 'comparisons': {'count': 1, 'input': {('i', 'j'): 2}, 'computed': None}}
...
#     assert f.report() == {'name': 'f', 'weight': 0.125, 'weights': {'local': {'l': 0.9, 'k': 0.1}, 'global': {'l': 0.1125, 'k': 0.0125}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 2, 'names': ['k', 'l']}, 'children': {'count': 2, 'names': ['k', 'l']}, 'comparisons': {'count': 1, 'input': {('k', 'l'): 0.1111111111111111}, 'computed': None}}
#     assert g.report() == {'name': 'g', 'weight': 0.125, 'weights': {'local': {'z': 0.6, 'y': 0.3, 'x': 0.1}, 'global': {'z': 0.075, 'y': 0.0375, 'x': 0.0125}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 3, 'names': ['x', 'y', 'z']}, 'children': None, 'comparisons': {'count': 3, 'input': {'x': 1, 'y': 3, 'z': 6}, 'computed': None}}
#     assert h.report() == {'name': 'h', 'weight': 0.25, 'weights': {'local': {'y': 0.4, 'z': 0.4, 'x': 0.2}, 'global': {'y': 0.1, 'z': 0.1, 'x': 0.05}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 3, 'names': ['x', 'y', 'z']}, 'children': None, 'comparisons': {'count': 3, 'input': {'x': 2, 'y': 4, 'z': 4}, 'computed': None}}
#     assert i.report() == {'name': 'i', 'weight': 0.2667, 'weights': {'local': {'y': 0.4, 'z': 0.4, 'x': 0.2}, 'global': {'y': 0.1067, 'z': 0.1067, 'x': 0.0533}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 3, 'names': ['x', 'y', 'z']}, 'children': None, 'comparisons': {'count': 3, 'input': {'x': 2, 'y': 4, 'z': 4}, 'computed': None}}
#     assert j.report() == {'name': 'j', 'weight': 0.1333, 'weights': {'local': {'z': 0.5, 'y': 0.3333, 'x': 0.1667}, 'global': {'z': 0.0666, 'y': 0.0444, 'x': 0.0222}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 3, 'names': ['x', 'y', 'z']}, 'children': None, 'comparisons': {'count': 3, 'input': {'x': 1, 'y': 2, 'z': 3}, 'computed': None}}
#     assert k.report() == {'name': 'k', 'weight': 0.0125, 'weights': {'local': {'y': 0.4, 'z': 0.4, 'x': 0.2}, 'global': {'y': 0.005, 'z': 0.005, 'x': 0.0025}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 3, 'names': ['x', 'y', 'z']}, 'children': None, 'comparisons': {'count': 3, 'input': {'x': 2, 'y': 4, 'z': 4}, 'computed': None}}
#     assert l.report() == {'name': 'l', 'weight': 0.1125, 'weights': {'local': {'m': 0.5, 'n': 0.5}, 'global': {'m': 0.0562, 'n': 0.0562}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 2, 'names': ['m', 'n']}, 'children': {'count': 2, 'names': ['m', 'n']}, 'comparisons': {'count': 1, 'input': {('m', 'n'): 1}, 'computed': None}}
#     assert m.report() == {'name': 'm', 'weight': 0.0562, 'weights': {'local': {'z': 0.5, 'y': 0.3333, 'x': 0.1667}, 'global': {'z': 0.0281, 'y': 0.0187, 'x': 0.0094}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 3, 'names': ['x', 'y', 'z']}, 'children': None, 'comparisons': {'count': 3, 'input': {'x': 1, 'y': 2, 'z': 3}, 'computed': None}}
#     assert n.report() == {'name': 'n', 'weight': 0.0562, 'weights': {'local': {'z': 0.6, 'y': 0.3, 'x': 0.1}, 'global': {'z': 0.0337, 'y': 0.0169, 'x': 0.0056}, 'target': None}, 'consistency_ratio': 0.0, 'random_index': 'Donegan & Dodd', 'elements': {'count': 3, 'names': ['x', 'y', 'z']}, 'children': None, 'comparisons': {'count': 3, 'input': {'x': 1, 'y': 3, 'z': 6}, 'computed': None}}
